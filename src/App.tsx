    ...
    >
      ...
      {sections.map((section, index) => (
        <div key={index} className="mb-6">
          <h3 className="text-xl font-semibold text-gray-800 mb-3">{section.heading}</h3>
...
const App: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-[#F5E8C7] font-sans">
      <header className="bg-[#EAD9A8] text-gray-900 py-16 text-center">
        <motion.h1
        ...
        >
          Seamlessly connect Ravan.ai with your favorite tools to supercharge your business automation and lead generation.
        </motion.p>
      </header>
        ...
        <div className="flex space-x-4 mb-8 overflow-x-auto pb-2">
          {integrations.map((integration, index) => (
            <button
              ...
              className={`px-4 py-2 rounded-t-lg ${activeTab === index ? 'bg-[#F28C38] text-white' : 'bg-[#EAD9A8] text-gray-900'}`}
            >
              {integration.title}
            </button>
          ))}
